$(function(){
	...
	var preencherForm = function(){
		...
		$('#mensagem').val('Bom dia! Gostaria de saber o preço para três máquinas para Santarém/PA');
	...
	$('#simples-formulario-ajax').submit(function(e){
		...
		$.ajax({
			...
			$( "#simples-formulario-ajax" ).prepend('<div class="alert alert-success alert-dismissible fade show" role="alert">Solicitação de contato enviado com Sucesso!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
    ...
    if (!$("#mainNav").length) { return false;  } // verifica existencia de #mainNav p/ ñ da erro
